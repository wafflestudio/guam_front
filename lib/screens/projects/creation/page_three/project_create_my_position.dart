        ...
        child: ToggleButtons(
          ...
          children: [
            Padding(
              ...
              child: Text('백엔드', style: TextStyle(fontSize: 14, color: Colors.white)),
            ),
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 5),
              child: Text('프론트엔드', style: TextStyle(fontSize: 14, color: Colors.white)),
            ),
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 5),
              child: Text('디자이너', style: TextStyle(fontSize: 14, color: Colors.white)),
            ),
          ],
        ),
      ),
