  ...
  Future fetchProjects(String authToken) async {
    try {
      ...
      List<Map<String, dynamic>> projects = [
        ...
        {'id': 5, "title": 'StackOverFlow 토이 프로젝트', 'difficulty': 1, 'thumbnail': "https://jessehouwing.net/content/images/size/w2000/2018/07/stackoverflow-1.png", 'devType': '웹', 'frontFramework': 'Flutter', 'frontHeadCount': 2, 'backFramework': "Spring boot", 'backHeadCount': 2, 'isRecruiting': true},
        {'id': 6, "title": 'Youtube 제작하기', 'difficulty': 1, 'thumbnail': "https://blog.kakaocdn.net/dn/BFi6P/btqu2a0vtPj/Yz8dSCZronFkrwkGxZ2PQ1/img.png", 'devType': '웹', 'frontFramework': 'Flutter', 'frontHeadCount': 2, 'backFramework': "Spring boot", 'backHeadCount': 2, 'isRecruiting': true},
        {'id': 7, "title": '커플앱 비트윈 카피앱 제작하기', 'difficulty': 1, 'thumbnail': "https://dtqvguqpjeirn.cloudfront.net/static/img/kr_jobs/ic_web_jobs_vision2@3x.png", 'devType': '웹', 'frontFramework': 'Flutter', 'frontHeadCount': 2, 'backFramework': "Spring boot", 'backHeadCount': 2, 'isRecruiting': true},
        {'id': 8, "title": '카카오톡 만들기', 'difficulty': 1, 'thumbnail': "https://upload.wikimedia.org/wikipedia/commons/thumb/d/de/Kakao_CI_yellow.svg/1200px-Kakao_CI_yellow.svg.png", 'devType': '웹', 'frontFramework': 'Flutter', 'frontHeadCount': 2, 'backFramework': "Spring boot", 'backHeadCount': 2, 'isRecruiting': true},
      ];
      ...
      List<Map<String, dynamic>> almostFullProjects = [
        ...
        {'id': 5, "title": '파이썬 빅데이터 스터디', 'difficulty': 1, 'thumbnail': "https://img1.daumcdn.net/thumb/R800x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2Fbd3g53%2FbtqEm3yi9Wf%2FRGX2fyBJrGs5vQQTEIUaK1%2Fimg.png", 'devType': '웹', 'frontFramework': 'Flutter', 'frontHeadCount': 2, 'backFramework': "Spring boot", 'backHeadCount': 2, 'isRecruiting': true},
        {'id': 6, "title": '배민 카피앱 개발', 'difficulty': 1, 'thumbnail': "https://pds.joins.com/news/component/htmlphoto_mmdata/201912/03/e157f4c7-2dc7-416c-8a88-d1a3dbfff9e8.jpg", 'devType': '웹', 'frontFramework': 'Flutter', 'frontHeadCount': 2, 'backFramework': "Spring boot", 'backHeadCount': 2, 'isRecruiting': true},
