  ...
  Future fetchProjects(String authToken) async {
    try {
      ...
      List<Map<String, dynamic>> almostFullProjects = [
        {'id': 1, "title": '비트코인 채굴기 만들기', 'description': '비트코인 채 프로젝트 해봐요!!!', 'time' : 3, 'difficulty': 1, 'thumbnail': "https://i.insider.com/602fd42fd3570b0018092849?width=1136&format=jpeg", 'devType': '웹', 'frontFramework': 'Flutter', 'frontHeadCount': 2, 'backFramework': "Spring boot", 'backHeadCount': 2, 'isRecruiting': true},
        ...
        {'id': 3, "title": '카풀 앱 제작하기', 'description': '제2의 우버를 만 프로젝트 해봐요!!!', 'time' : 3, 'difficulty': 1, 'thumbnail': "https://img.hankyung.com/photo/201812/01.18444541.1.png", 'devType': '웹', 'frontFramework': 'Flutter', 'frontHeadCount': 2, 'backFramework': "Spring boot", 'backHeadCount': 2, 'isRecruiting': true},
        ...
        {'id': 5, "title": '파이썬 빅데이터 스터디', 'description': '하둡, 스파크와 연동할 수 있는 파이프라인 구 프로젝트 해봐요!!!', 'time' : 3, 'difficulty': 1, 'thumbnail': "https://img1.daumcdn.net/thumb/R800x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2Fbd3g53%2FbtqEm3yi9Wf%2FRGX2fyBJrGs5vQQTEIUaK1%2Fimg.png", 'devType': '웹', 'frontFramework': 'Flutter', 'frontHeadCount': 2, 'backFramework': "Spring boot", 'backHeadCount': 2, 'isRecruiting': true},
